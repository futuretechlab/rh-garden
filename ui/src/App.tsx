...
function SuzukiField({explorer, proofMode}: {explorer: ExplorerData; proofMode: boolean}) {
  ...
  return <section className="screen">
    ...
    {proofMode ? <ProofModeVeil title="Numerical field hidden"><p>Proof Mode preserves the exact representation and certified intervals, while hiding sampled values.</p><div className="certified-range"><b>[0, log 5]</b><span>nonnegative; strict positivity proved on (0, log 3] · LeanChecked</span></div></ProofModeVeil> : <>
...
function CertificateWorkbench({busy}: {busy: BusyPeriod[]}) {
  ...
  return <section className="screen">
    ...
    <div className="tail-strip"><span>FINITE CERTIFIED COVERAGE</span><b>[0, log 5]</b><i /><span>UNCERTIFIED TAIL</span><b>(log 5, ∞)</b></div>
  </section>
}
