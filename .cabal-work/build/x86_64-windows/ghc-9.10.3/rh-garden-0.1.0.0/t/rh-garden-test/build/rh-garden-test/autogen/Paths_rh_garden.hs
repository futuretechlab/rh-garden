...
-- at runtime using the environment variable rh_garden_bindir.
...
-- environment variable rh_garden_libdir.
...
-- using the environment variable rh_garden_dynlibdir.
...
-- runtime using the environment variable rh_garden_datadir.
...
-- using the environment variable rh_garden_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.10.3-b42a\\rh-garden-0.1.0.0-inplace-rh-garden-test"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.10.3-b42a"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.10.3-b42a\\rh-garden-0.1.0.0"
libexecdir = "C:\\cabal\\rh-garden-0.1.0.0-inplace-rh-garden-test\\x86_64-windows-ghc-9.10.3-b42a\\rh-garden-0.1.0.0"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "rh_garden_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "rh_garden_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "rh_garden_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "rh_garden_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "rh_garden_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "rh_garden_sysconfdir") (\_ -> return sysconfdir)
